...
from typing import Any, TypedDict, cast, List, Optional
...
async def add_memory(
    name: str = Field(..., description="Name of the memory episode"),
    episode_body: str = Field(..., description="Content of the episode to store"),
    group_id: str | None = Field(None, description="Optional memory graph group identifier"),
    source: str = Field('text', description="Source type: 'text', 'json', or 'message'"),
    source_description: str = Field('', description="Description of the content source"),
    uuid: str | None = Field(None, description="Optional episode UUID"),
...
async def search_memory_nodes(
    ...
    group_ids: Optional[List[str]] = Field(
        None,
        description="Optional list of group IDs to filter",
        examples=[["grp1", "grp2"]]
    ),
    max_nodes: int = Field(10, description="Maximum number of nodes to return"),
    center_node_uuid: Optional[str] = Field(None, description="UUID of the root node for context"),
    entity: str = Field('', description="Entity filter string (cursor broken with None)"),
...
async def search_memory_facts(
    ...
    max_facts: int = Field(10, description="Maximum number of facts to return"),
    center_node_uuid: Optional[str] = Field(None, description="UUID of the root node for context"),
...
async def get_episodes(
    group_id: Optional[str] = Field(None, description="Optional group ID to filter episodes"),
    last_n: int = Field(10, description="Number of recent episodes to retrieve"),
